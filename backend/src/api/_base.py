...
from api import auth_rtr, customer_rtr, order_rtr, product_rtr, dicts_rtr, report_rtr
...
api_router.include_router(report_rtr.router, prefix="/reports", tags=["Reports"])
